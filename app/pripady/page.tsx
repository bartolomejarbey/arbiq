...
const cases = [
  ...
  {
    number: "#002",
    name: "greenderatizace.cz",
    url: "https://greenderatizace.cz",
    screenshot: "/ilustrace/references/green.png",
    summary: "DDD služby (deratizace, dezinsekce, dezinfekce) nonstop. Multi-stránkový web s ceníkem, službami a kontaktním flow.",
    tags: ["WEBDESIGN", "DDD", "B2B"],
    rotation: "-rotate-[1deg]",
  },
  {
    number: "#003",
  ...
  {
    number: "#009",
    name: "likvidaceahubenihrabosu.cz",
    url: "https://likvidaceahubenihrabosu.cz",
    screenshot: "/ilustrace/references/likvidace.png",
    summary: "Profesionální deratizace pozemků — nonstop 24/7, výskyty hrabošů na zahradách, pozemcích a zemědělských plochách. Web s poptávkovým formulářem.",
