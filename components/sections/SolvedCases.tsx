...
const cases = [
  ...
  {
    number: "#004",
    domain: "refreshstudio.cz",
    url: "https://refreshstudio.cz",
    screenshot: "/ilustrace/references/refreshstudio.png",
    summary: "Wellness studio v Kadani — Human Regenerator (plazmaterapie), masáže, EMS Kegel Chair. Prodej terapií a dárkových poukazů.",
    tags: ["WEBDESIGN", "WELLNESS", "E-SHOP"],
    rotation: "rotate-[1deg]",
  },
  {
    number: "#005",
    domain: "greenderatizace.cz",
    url: "https://greenderatizace.cz",
    screenshot: "/ilustrace/references/green.png",
    summary: "DDD služby — deratizace, dezinsekce, dezinfekce nonstop. Multi-stránkový web s ceníkem a kontaktním flow.",
