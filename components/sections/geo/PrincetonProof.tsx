...
export default function PrincetonProof() {
  return (
    <section id="dukaz" className="py-20 md:py-32 bg-parchment paper-texture text-espresso-text scroll-mt-32 md:scroll-mt-44">
      <div className="max-w-4xl mx-auto px-6 md:px-12">
        <RevealOnScroll>
          <DetectiveTag variant="light" className="mb-4">AKADEMICKÝ DŮKAZ</DetectiveTag>
          <h2 className="font-display font-black text-espresso-text text-3xl md:text-5xl mb-8 leading-tight">
            Princeton, Georgia Tech a Allen Institute to změřili
          </h2>
        </RevealOnScroll>

        <RevealOnScroll delay={0.1}>
          <div className="text-brown-muted text-base md:text-lg leading-relaxed space-y-6 mb-12 font-serif-alt">
            <p>
        ...
        <RevealOnScroll delay={0.2}>
          <blockquote className="bg-parchment-aged/60 border-l-4 border-espresso-text/30 p-6 md:p-10 mb-8 relative">
            <Quote
              size={28}
              className="absolute top-4 right-6 text-espresso-text/20"
              strokeWidth={1}
            />
            <p className="font-display italic text-lg md:text-2xl text-espresso-text leading-relaxed mb-6">
